...
function scrollUp() {
    ...
    // when scroll is higher than 560 viewport height, add the show-scroll class to the a tag with the scroll
...
if(selectedTheme) {
    // If the validation is fulfilled, we ask what the issue was know if we activated of deactivated the dark theme
